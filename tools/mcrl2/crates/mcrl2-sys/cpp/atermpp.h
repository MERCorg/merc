...
inline
const detail::_function_symbol* mcrl2_function_symbol_address(const function_symbol& symbol)
{
...
inline
void mcrl2_aterm_pool_enable_automatic_garbage_collection(bool enabled)
{
  detail::g_term_pool().enable_garbage_collection(enabled);
}

inline
std::size_t mcrl2_aterm_pool_size() {
  return detail::g_term_pool().size();
}

inline
std::size_t mcrl2_aterm_pool_capacity()
{
  return detail::g_term_pool().capacity();
}

inline 
void mcrl2_aterm_pool_collect_garbage()
{
  detail::g_thread_term_pool().collect();
}

inline
void mcrl2_aterm_pool_test_garbage_collection()
{
...
inline
void mcrl2_aterm_pool_lock_shared() 
{
  detail::g_thread_term_pool().shared_mutex().lock_shared_impl();
}

inline
bool mcrl2_aterm_pool_unlock_shared() 
{
...
inline
void mcrl2_aterm_pool_lock_exclusive() 
{
  detail::g_thread_term_pool().shared_mutex().lock_impl();
}

inline
void mcrl2_aterm_pool_unlock_exclusive() 
{
  detail::g_thread_term_pool().shared_mutex().unlock();
}

inline
std::unique_ptr<tls_callback_container> mcrl2_aterm_pool_register_mark_callback(void_callback callback_mark, size_callback callback_size)
{
  return std::make_unique<tls_callback_container>(callback_mark, callback_size);
}

inline
void mcrl2_aterm_pool_print_metrics()
{
...
inline
const detail::_aterm* mcrl2_aterm_create(const detail::_function_symbol* symbol, rust::Slice<const detail::_aterm* const> arguments)
{
  ...
  unprotected_function_symbol tmp(symbol);
  make_term_appl(reinterpret_cast<aterm&>(result), reinterpret_cast<const function_symbol&>(tmp), aterm_slice.begin(), aterm_slice.end());
  return detail::address(result);
}

inline
std::unique_ptr<aterm> mcrl2_aterm_from_string(rust::String text)
{
  return std::make_unique<aterm>(read_term_from_string(static_cast<std::string>(text)));
}

inline
const detail::_aterm* mcrl2_aterm_get_address(const aterm& term)
{
  return detail::address(term);
}

inline
void mcrl2_aterm_mark_address(const detail::_aterm* term, term_mark_stack& todo)
{
  mark_term(*term, todo);
}

inline
bool mcrl2_aterm_is_list(const detail::_aterm* term)
{
...
inline
bool mcrl2_aterm_is_empty_list(const detail::_aterm* term)
{
  atermpp::unprotected_aterm_core t(term);
...
inline
bool mcrl2_aterm_is_int(const detail::_aterm* term)
{
  atermpp::unprotected_aterm_core t(term);
...
inline
rust::String mcrl2_aterm_print(const detail::_aterm* term)
{
  atermpp::unprotected_aterm_core t(term);
...
inline
const detail::_function_symbol* mcrl2_aterm_get_function_symbol(const detail::_aterm* term)
{ 
  return mcrl2_function_symbol_address(atermpp::unprotected_aterm_core(term).function());
}

inline
const detail::_aterm* mcrl2_aterm_get_argument(const detail::_aterm* term, std::size_t index)
{
  atermpp::unprotected_aterm_core t(term);
...
inline
const detail::_function_symbol* mcrl2_function_symbol_create(rust::String name, std::size_t arity)
{
...
inline
const detail::_function_symbol* mcrl2_function_symbol_get_address(const function_symbol& symbol)
{
  return mcrl2_function_symbol_address(symbol);
}

inline
rust::Str mcrl2_function_symbol_get_name(const detail::_function_symbol* symbol)
{
  return symbol->name();
}

inline
std::size_t mcrl2_function_symbol_get_arity(const detail::_function_symbol* symbol)
{
  return symbol->arity();
}

inline
void mcrl2_function_symbol_protect(const detail::_function_symbol* symbol)
{
  symbol->increment_reference_count();
}

inline
void mcrl2_function_symbol_drop(const detail::_function_symbol* symbol)
{
